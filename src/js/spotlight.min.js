...
(function () {
  ...
  function Qa() {
    Ra ||
      ...
      (Ga = [
        ...
        [Q, "mouseup", Xa],
        [Q, "mousemove", Ya],
        [Q, "touchstart", Wa, { passive: !1 }],
        [Q, "touchcancel", Xa],
        [Q, "touchend", Xa],
        [Q, "touchmove", Ya, { passive: !0 }],
        [P, "", Za],
        [za, "", $a],
        [Ba, "", W],
        [Da, "", ab],
  ...
  function ab(a) {
    ("boolean" === typeof a ? a : !R)
      ? R || ((R = setInterval(W, ua)), f(Da, "on"), sa && lb())
      : R &&
        ((R = clearInterval(R)), h(Da, "on"), sa && m(Ea, "transform", ""));
    return R;
  }
  function Y() {
  ...
  function Za(a) {
    (
      ...
      ? (document.cancelFullScreen(), h(P, "on"))
      : (T.requestFullScreen(), f(P, "on"));
  }
  function bb(a) {
  ...
  function Ja(a) {
    ...
    if ((c = (c = a.title || a.description) && "false" !== c))
      ka(xa, a.title || ""), ka(ya, a.description || "");
